...
object DataLoader {
  ...
  // 定义常量
  val MOVIE_DATA_PATH = "C:\\Users\\ASUS\\Desktop\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\movies.csv"
  val RATING_DATA_PATH = "C:\\Users\\ASUS\\Desktop\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\ratings.csv"
  val TAG_DATA_PATH = "C:\\Users\\ASUS\\Desktop\\MovieRecommendSystem\\recommender\\DataLoader\\src\\main\\resources\\tags.csv"
  ...
  def main(args: Array[String]): Unit = {
    ...
    val config = Map(
      "spark.cores" -> "local[*]",
      "mongo.uri" -> "mongodb://192.168.77.77:27017/recommender",
      "mongo.db" -> "recommender",
      "es.httpHosts" -> "192.168.77.77:9200",
      "es.transportHosts" -> "192.168.77.77:9300",
      //"es.httpHosts" -> "centos:9200",
      //"es.transportHosts" -> "centos:9300",
    ...
    implicit val mongoConfig = MongoConfig(config("mongo.uri"), config("mongo.db"))//隐式定义
